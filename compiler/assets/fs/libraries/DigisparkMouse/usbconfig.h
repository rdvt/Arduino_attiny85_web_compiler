 ...
 * *** IMPORTANT NOTE ***
 * Este dispositivo usa el par compartido de obdev 0x16c0/0x27DA, reservado
 * para "USB Mice" con discriminacion por serial. El texto original que decia
 * 0x16c0/0x5dc era copy-paste del template de V-USB y no aplica a esta
 * libreria. Ver USB-IDs-for-free.txt.
 */
 ...
 * OJO: si usas el par compartido de obdev, mira las reglas en
 * USB-IDs-for-free.txt. Con el PID 0x27DA (USB Mice) la regla del dominio
 * aplica al SERIAL NUMBER, no al nombre del fabricante.
 */
#define USB_CFG_DEVICE_NAME     'U','S','B',' ','M','o','u','s','e'
#define USB_CFG_DEVICE_NAME_LEN 9
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   'm','i','d','o','m','i','n','i','o','.','c','o','m',':','M','o','u','s','e'
#define USB_CFG_SERIAL_NUMBER_LEN   19
/* Same as above for the serial number. If you don't want a serial number,
 * undefine the macros.
 * *** CAMBIAR 'midominio.com' POR TU DOMINIO O EMAIL ***
 * Con el PID 0x27DA obdev exige que el serial empiece con un dominio o email
 * TUYO terminado en ':' (ej. "tudominio.com:Mouse"). Lo que va despues de los
 * dos puntos es libre y sirve para distinguir varios dispositivos tuyos.
